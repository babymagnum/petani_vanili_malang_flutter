...
class HighResolutionView extends StatefulWidget {
  ...
  HighResolutionView({Key key, @required this.produkDescription, @required this.produkImage, @required this.produkName}): super(key: key);
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: <Widget>[
              ...
              Spacer(),
              Image.asset('assets/images/ic_share.png', width: 24.w, height: 24.h, color: Colors.white,),
              SizedBox(width: 25.w,),
